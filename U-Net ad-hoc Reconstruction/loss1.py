...
def loss1(input_train_tm_tens,input_train_tp_tens,dfat_train_t_tens,te_train_t_tens,w_mean_r,w_std_r,f_mean_r,f_std_r,w_mean_i,w_std_i,f_mean_i,f_std_i,frq_mean,frq_std,r2_mean,r2_std,output_pred):
    ...
    input_train_t_mag = input_train_tm_tens[:,:,:,0:NUM_ECHOS]
    input_train_t_phs = input_train_tp_tens[:,:,:,0:NUM_ECHOS]
